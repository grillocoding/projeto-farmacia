    ...
    <form action="{{ route('medicamentos.update', $medicamento) }}" method="POST"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" name="principio_ativo" value="{{ old('principio_ativo', $medicamento->principio_ativo) }}"
                       class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-400
            ...
            <div>
                ...
                <input type="text" name="fabricante" value="{{ old('fabricante', $medicamento->fabricante) }}"
                       class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-400
            ...
            <div>
                ...
                <input type="text" name="categoria" value="{{ old('categoria', $medicamento->categoria) }}"
                       class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-400
            ...
            <div>
                ...
                <input type="number" name="preco" step="0.01" value="{{ old('preco', $medicamento->preco) }}"
                       class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-400
            ...
            <div>
                ...
                <input type="number" name="estoque" value="{{ old('estoque', $medicamento->estoque) }}"
                       class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-400
            ...
            <div>
                ...
                <input type="date" name="validade" value="{{ old('validade', $medicamento->validade?->format('Y-m-d')) }}"
                       class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-400
        ...
        <div class="flex items-center gap-2">
            <input type="checkbox" name="requer_receita" id="requer_receita" value="1"
                   {{ old('requer_receita', $medicamento->requer_receita) ? 'checked' : '' }}
        ...
        <div>
            ...
            <textarea name="descricao" rows="3"
                      class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-400">{{ old('descricao', $medicamento->descricao) }}</textarea>
        </div>
