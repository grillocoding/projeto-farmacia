...
<div class="max-w-2xl mx-auto">
    <h1 class="text-xl font-bold text-gray-800 mb-6">Novo Usuário</h1>
    ...
    <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="flex gap-3 pt-2">
            <button type="submit"
                    class="bg-teal-500 hover:bg-teal-600 text-white px-5 py-2 rounded-lg text-sm font-semibold transition shadow-sm">
                Salvar
            </button>
